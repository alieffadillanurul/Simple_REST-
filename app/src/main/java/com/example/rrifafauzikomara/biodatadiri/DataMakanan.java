    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... params){
                ...
                String s = rh.sendGetRequest("https://abdurrobbi007.000webhostapp.com/simplerestandroid-master/simplerestandroid-master/web_service/Makanan/get_all_makanan.php");
                return s;
            }
        }
